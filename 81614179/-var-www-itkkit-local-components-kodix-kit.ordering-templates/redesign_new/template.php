...
global $USER;
    ...
    foreach($arResult["AVAILABLE"] as $arItem){
        ...
        $itemsPriceCurrent = $itemsPriceCurrent + KDXCurrency::convert($useVAT=="N" ? $arItem['PRICE'] / ($arItem['VAT_RATE'] + 1) * $arItem['QUANTITY'] : $arItem['PRICE'] * $arItem['QUANTITY'], KDXCurrency::$CurrentCurrency);
        $itemsPriceOld = $itemsPriceOld + KDXCurrency::convert($useVAT=="N" ? $arItem['PROPS']['BASE_PRICE_P'] / ($arItem['VAT_RATE'] + 1) * $arItem['QUANTITY'] : $arItem['PROPS']['BASE_PRICE_P'] * $arItem['QUANTITY'], KDXCurrency::$CurrentCurrency);
    }
                                            ...
                                            <div class="price <?if($arItem['PROPS']['BASE_PRICE_P'] > $arItem['PRICE']){?>price--has-discount<?}?>">
                                                <span class="price__block">
                                                    <span class="price--current">
                                                        ...
                                                        <?=KDXCurrency::convertAndFormat($useVAT=="N" ? $arItem['PRICE'] / ($arItem['VAT_RATE'] + 1) * $arItem['QUANTITY'] : $arItem['PRICE'] * $arItem['QUANTITY'], KDXCurrency::$CurrentCurrency)?>
                                                    </span>
                                                </span>
                                                <?if($arItem['PROPS']['BASE_PRICE_P'] > $arItem['PRICE']){?>
                                                    <span class="price--old">
                                                        <span>
                                                            ...
                                                            <?=KDXCurrency::convertAndFormat($useVAT=="N" ? $arItem['PROPS']['BASE_PRICE_P'] / ($arItem['VAT_RATE'] + 1) * $arItem['QUANTITY'] : $arItem['PROPS']['BASE_PRICE_P'] * $arItem['QUANTITY'], KDXCurrency::$CurrentCurrency)?>
                                                        </span>
                                                    </span>
                                                <?}?>
                                            </div>
                                ...
                                <div class="col-md-12">
                                    <table class="checkout-summary__table">
                                        ...
                                        <?
                                            ...
                                            foreach($arResult["AVAILABLE"] as $arItem){
                                                $itemsPriceCurrentEur = $itemsPriceCurrentEur + KDXCurrency::convert($useVAT=="N" ? $arItem['PRICE'] / ($arItem['VAT_RATE'] + 1) * $arItem['QUANTITY'] : $arItem['PRICE'] * $arItem['QUANTITY'], 'EUR');
                                            }
                                        ?>
                                            <tr class="checkout-summary__table-total">
