...
if (LANGUAGE_ID == 'en'){
    $APPLICATION->SetPageProperty('title', 'Shop '.$arResult['NAME'].' at itk online store');
    $APPLICATION->SetPageProperty('description', 'Shop '.$arResult['NAME'].' at itk online store. Free Shipping on All Orders Over €350 &#10003; Fast Delivery &#10003; 14 Days Return Policy &#10003; 100% Authenticity &#10003;');
} else {
