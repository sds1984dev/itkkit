...
foreach($arResult as $key => $arItem){
    ...
    if($current_depth == 1){
        ...
        if($arItem['PARAMS']['BRANDS'] == "Y") {
           $cache_filename='/var/www/itkkit/local/cache_sql/'.$_SERVER['HTTP_HOST'].'_local_templates_.default_components_bitrix_menu_kit_main_new_mobile_result_modifier.newMenu_26.obj';
