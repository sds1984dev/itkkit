...
//    if (isset($value['item']['ITEM_INDEX']) && in_array($value['item']['ITEM_INDEX'], $arSectionIndexes)) {
//        if (isset($value['children']) && is_array($value['children'])) {
//            foreach($value['children'] as $key => $value) {
//                $arTemp[$key] = $value;
//            }
//        }
//        usort($arTemp, 'customSort');
////        echo "<pre>";
////        print_r($arTemp);
////        echo "</pre>";
////        break;
////        $arResult[$key] = array_values($arTemp);
//    }
//}
