...
global $USER;
    ...
    foreach($arResult["AVAILABLE"] as $arItem){        
        $itemsPriceCurrent = $itemsPriceCurrent + KDXCurrency::convert($useVAT=="N" ? ($arItem['PRICE'] / 1.21) * $arItem['QUANTITY'] : $arItem['PRICE'] * $arItem['QUANTITY'], KDXCurrency::$CurrentCurrency);
        $itemsPriceOld = $itemsPriceOld + KDXCurrency::convert($useVAT=="N" ? ($arItem['PROPS']['BASE_PRICE_P'] / 1.21) * $arItem['QUANTITY'] : $arItem['PROPS']['BASE_PRICE_P'] * $arItem['QUANTITY'], KDXCurrency::$CurrentCurrency);
    }
                                            ...
                                            <div class="price <?if($arItem['PROPS']['BASE_PRICE_P'] > $arItem['PRICE']){?>price--has-discount<?}?>">
                                                <span class="price__block">
                                                    <span class="price--current">
                                                        ...
                                                        <?=KDXCurrency::convertAndFormat($useVAT=="N" ? ($arItem['PRICE'] / 1.21) * $arItem['QUANTITY'] : $arItem['PRICE'] * $arItem['QUANTITY'], KDXCurrency::$CurrentCurrency)?>
                                                    </span>
                                                </span>
                                                <?if($arItem['PROPS']['BASE_PRICE_P'] > $arItem['PRICE']){?>
                                                    <span class="price--old">
                                                        <span>
                                                            ...
                                                            <?=KDXCurrency::convertAndFormat($useVAT=="N" ? ($arItem['PROPS']['BASE_PRICE_P'] / 1.21) * $arItem['QUANTITY'] : $arItem['PROPS']['BASE_PRICE_P'] * $arItem['QUANTITY'], KDXCurrency::$CurrentCurrency)?>
                                                        </span>
                                                    </span>
                                                <?}?>
                                            </div>
                                                    ...
                                                    <div class="price">
                                                        <span class="price__block">
                                                                ...
                                                                <?
                                                                    ...
                                                                    <?} else {?>
                                                                        <?=KDXCurrency::convertAndFormat($itemsPriceCurrent/1.21,KDXCurrency::$CurrentCurrency);?>
                                                                    <?}?>
                                                                </span>
                                                        </span>
                                                    </div>
                                                        ...
                                                        <div class="price">
                                                            <span class="price__block">
                                                                <span class="price--current">
                                                                    ...
                                                                    <?
                                                                    echo '<pre>';
                                                                    print_r ($itemsPriceCurrent*1.21-$itemsPriceCurrent);
                                                                    echo '</pre>';
