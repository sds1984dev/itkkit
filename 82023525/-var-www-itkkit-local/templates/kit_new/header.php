...
if (isset($_SESSION['CHECKWORD']) && $_SESSION['CHECKWORD'] != '') {
    setcookie('CHECKWORD', $_SESSION['CHECKWORD'], time() + 60 * 60 * 24 * 10);
    unset($_SESSION['CHECKWORD']);
} elseif (!isset($_SESSION['CHECKWORD'])) {
    setcookie('CHECKWORD', '', 1);
}
