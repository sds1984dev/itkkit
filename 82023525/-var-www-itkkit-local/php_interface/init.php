...
function mandrill_send_mail($template, $to, $subject){
    ...
    //признак для вставки контента - $template=='SKARYUK_SALE_NEW_ORDER'
...
//AddEventHandler("main", "OnBeforeUserRegister", "sendUserData");
//function sendUserData(&$arFields) {
//
//    if (isset($arFields['CHECKWORD']))
//        $_SESSION['CHECKWORD'] = $arFields['CHECKWORD'];
//
////    print_r($arFields);die();
////    Array ( [LOGIN] => sds_1984@mail.ru [NAME] => ddd [LAST_NAME] => sss [PASSWORD] => qwert [CHECKWORD] => 3b4cff34d3c39de55c1ee7b09bf63f6f [~CHECKWORD_TIME] => now() [CONFIRM_PASSWORD] => qwert [EMAIL] => sds_1984@mail.ru [ACTIVE] => Y [CONFIRM_CODE] => [SITE_ID] => s1 [USER_IP] => 94.25.231.154 [USER_HOST] => client.yota.ru [GROUP_ID] => Array ( [0] => 3 [1] => 4 [2] => 5 ) [LID] => s1 [RESULT_MESSAGE] => Array ( [MESSAGE] => Пароль должен быть не менее 6 символов длиной.
////    [TYPE] => ERROR ) )
//
////    $fields = Array(
