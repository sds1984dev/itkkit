<?php
/**
 * Created by:  KODIX 20.03.2015 16:18
    ...
    <div class="grid-row">
        ...
        <?foreach($arResult['ITEMS'] as $arProduct){
            ...
            <div class="col-xl-3 col-lg-4 col-md-4 col-tm-6 col-sm-12">
                <a class="catalog-item catalog-item--compact link link--primary" href="<?=$arProduct['DETAIL_PAGE_URL']?>" onmousedown="try { rrApi.recomMouseDown(<?=$arProduct['ID']?>, {methodName: <?=$_POST['query']?>}) } catch(e) {}">
