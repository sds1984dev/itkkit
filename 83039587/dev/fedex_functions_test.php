...
function track_shipment($tracknumber)
{
    ...
    require_once('fedex-common_custom_test.php');
...
//    die();
    ...
    require_once('/var/www/itkkit/bitrix/admin/fedex/fedex-common_custom_test.php');
...
//echo '</pre>';
    ...
    try{
        ...
        if ($response->HighestSeverity != 'FAILURE' && $response->HighestSeverity != 'ERROR'){
            ...
            $output = '<!DOCTYPE html><html><head><meta charset="utf-8"><title><54536_shipexpresslabel.png</title></head><body><img src="'.$order_data['order_id'].'_shipexpresslabel.png"></body></html>';
            ...
            echo '<a href="https://itkkit.ru/bitrix/admin/sale_print.php?PROPS_ENABLE=Y&doc=waybillnew_1&ORDER_ID='.$order_data['order_id'].'&SHOW_ALL=Y">Инвойс на заказ №'.$order_data['order_id'].'</a></br>';
...
function fedex_addr_validation($order_data){
    //Валидация адреса
    include_once('fedex-common_custom_test.php');
