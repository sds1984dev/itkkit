...
function showCatalogItem($arProduct, $params = array())
{
    ...
    $arProduct['VAT_RATE'] = ($arProduct['IBLOCK_SECTION_ID'] == 554) ? 1.12 : 1.21;

    $nav = CIBlockSection::GetNavChain(false, $arProduct['IBLOCK_SECTION_ID']);
    $path = '/catalog';
    ...
    $brandId = null;
    $iterator = CIBlockElement::GetProperty(1, $arProduct['ID'],array(),array('ID' => 1));
    ...
    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
        <a class="catalog-item catalog-item--compact link link--primary" href="<?=$arProduct['DETAIL_PAGE_URL']?>" onclick="addProductInfoDataLayer()">
                    ...
                    <?if($arProduct['PROPERTY_BASE_PRICE_MIN_VALUE']>$arProduct['PROPERTY_RETAIL_PRICE_MIN_VALUE']){?>
                        ...
                        <span class="price__block">
                            <span class="price--current">
                                ...
                                <?=KDXCurrency::convert($useVAT=="N" ? $arProduct['RETAIL_PRICE'] / $arProduct['VAT_RATE'] : $arProduct['RETAIL_PRICE'], $curCurrency)?>
                        ...
                        <span class="price--old">
                            <span>
                                ...
                                <?//=KdxCurrency::convertAndFormat($useVAT=="N" ? $arProduct['BASE_PRICE'] / 1.$arProduct['VAT_RATE'] : $arProduct['BASE_PRICE'],KDXCurrency::$CurrentCurrency)?>
                                <?=KDXCurrency::convert($useVAT=="N" ? $arProduct['BASE_PRICE'] / $arProduct['VAT_RATE'] : $arProduct['BASE_PRICE'], $curCurrency)?>
                                <?=KDXCurrency::GetCurrencyName($curCurrency)?>
                             </span>
                        </span>
                    <?}else{?>
                        <span class="price__block">
                            <span>
                                <?if($arProduct['PROPERTY_RETAIL_PRICE_MAX_VALUE']>$arProduct['PROPERTY_RETAIL_PRICE_MIN_VALUE']){?><?=GetMessage('KF_PRICE_FROM')?><?}?>
                                <?//=KdxCurrency::convertAndFormat($useVAT=="N" ? $arProduct['RETAIL_PRICE'] / 1.$arProduct['VAT_RATE'] : $arProduct['RETAIL_PRICE'],KDXCurrency::$CurrentCurrency)?>
                                <?=KDXCurrency::convert($useVAT=="N" ? $arProduct['RETAIL_PRICE'] / $arProduct['VAT_RATE'] : $arProduct['RETAIL_PRICE'], $curCurrency)?>
                                <?=KDXCurrency::GetCurrencyName($curCurrency)?>
                            </span>
                        </span>
