...
function getProperty($var){
        ...
        if($var == 'key') Return 'XcuR7gGeUElPF8EE'; 
	if($var == 'password') Return 'fTizlkwhrNqvdYyWWxbwmJFAB '; 
	if($var == 'parentkey') Return 'Hb1TfWMygUh7bbHP';          
	if($var == 'parentpassword') Return 'u0mnYl8d6FRQK5Ot8SyxMXVqq'; 
	if($var == 'shipaccount') Return '592302241';
	if($var == 'billaccount') Return '592302241';
	if($var == 'dutyaccount') Return '592302241'; 
	if($var == 'freightaccount') Return '592302241';  
	if($var == 'trackaccount') Return '592302241'; 
	if($var == 'dutiesaccount') Return '592302241';
	if($var == 'importeraccount') Return '592302241';
	if($var == 'brokeraccount') Return '592302241';
	if($var == 'distributionaccount') Return '592302241';
...
function setEndpoint($var){
    ...
    if($var == 'endpointETD') Return 'https://ws.fedex.com:443/web-services/uploaddocument';
}
