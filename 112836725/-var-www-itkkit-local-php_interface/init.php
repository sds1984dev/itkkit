...
AddEventHandler('sale', 'OnOrderSave', 'ChangeOrderStatus');
function ChangeOrderStatus($id, $arFields) {
    if (isset($arFields['TRACKING_NUMBER']) && $arFields['TRACKING_NUMBER'] != '') {
        if (!CSaleOrder::StatusOrder($id, "S")) 
