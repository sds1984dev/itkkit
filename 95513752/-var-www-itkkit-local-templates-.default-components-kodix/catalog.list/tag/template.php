...
<?if(!isAjax()){?>
    <div class="tags-list">
        ...
        $resTag = CIBlockElement::GetList(array(),array('IBLOCK_ID'=>21,'ACTIVE'=>'Y','IBLOCK_SECTION_ID'=>584,'=PROPERTY_SHOW'=>$getCurUrl,'=PROPERTY_SITE_VALUE'=>LANGUAGE_ID,'!=PROPERTY_FILTER'=>false),false,array(),array('*','PROPERTY_*'));
        while ($arTag = $resTag->Fetch()){
            echo '<a href="'.$getCurUrl.$arTag['CODE'].'/">'.$arTag['NAME'].'</a>';
        }
