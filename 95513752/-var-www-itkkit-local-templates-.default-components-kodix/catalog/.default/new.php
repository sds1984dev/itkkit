...
$APPLICATION->AddHeadString('<meta property="og:title" content="Latest Arrivals at itk online store"/>');
$APPLICATION->AddHeadString('<meta property="og:type" content="website"/>');
$APPLICATION->AddHeadString('<meta property="og:url" content="https://www.itkkit.com/catalog/new/"/>');
$APPLICATION->AddHeadString('<meta property="og:site_name" content="Itkkit.com" />');
$APPLICATION->AddHeadString('<meta property="og:description" content="Latest Arrivals at itk online store. Free Shipping on All Orders Over €350 ✓ Fast Delivery ✓ 14 Days Return Policy ✓ 100% Authenticity ✓
"/>');
...
$APPLICATION->AddHeadString('<meta property="twitter:url" content="https://www.itkkit.com/catalog/new/"/>');
$APPLICATION->AddHeadString('<meta property="twitter:title" content="Latest Arrivals at itk online store"/>');
$APPLICATION->AddHeadString('<meta property="twitter:description" content="Latest Arrivals at itk online store. Free Shipping on All Orders Over €350 ✓ Fast Delivery ✓ 14 Days Return Policy ✓ 100% Authenticity ✓
"/>');
