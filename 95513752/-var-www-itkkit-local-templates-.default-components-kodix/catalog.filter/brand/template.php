    ...
    <form action="<?= $APPLICATION->GetCurPageParam('', array('FILTER')) ?>"
        ...
        <div class="catalog-filter__wrapper">
            <div class="catalog-filter__open ninja--md ninja--lg ninja--xl">
                <a class="link link--lg js_catalog-filter__open"
                ...
                <div class="grid-container">
                    <div class="catalog-filter__content">
                        ...
                        <div class="grid-row">
                            ...
                            if (count($arResult['PROPERTY_VALUES'][$prop['CODE']]) > 1) { ?>
                                <div class="col-xl-3 col-lg-4 col-md-4 col-xs-12 col-padding catalog-filter--brands">
                                    <!-- list transforms to accordion on mobile version-->
                                    <div class="catalog-filter__accordion accordion">
                                        <div class="accordion__item js-accordion__item">
                                            ...
                                            <div class="accordion__content accordion__content--visible-md js-accordion__content"
                                                 data-prop="<?= $prop['CODE']; ?>">
                                                <div class="catalog-filter__list customscroll js_customscroll">
                                    ...
                                    <div class="catalog-filter__accordion accordion">
                                        <? foreach ($arResult['CHILDREN_SECTIONS'] as $arSection) { ?>
                                            ...
                                            <div class="accordion__item js-accordion__item <? if ($needShow) { ?>accordion__item--opened<? } ?>">
                                                <div class="accordion__title js-accordion__title"><a href="/catalog/brand/<?=$arParams['BRANDS_FILTER']?><?=str_replace('/catalog', '', $arSection['SECTION_PAGE_URL'])?>"><?= LANGUAGE_ID == 'en' ? $arSection['UF_EN_NAME'] : $arSection['NAME'] ?></a></div>
                                                                ...
                                                                <li class="catalog-filter__list-item">
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <div class="checkbox__label">
                                                                            <a href="/catalog/brand/<?=$arParams['BRANDS_FILTER']?><?=str_replace('/catalog', '', $arSubSection['SECTION_PAGE_URL'])?>" class="form_lbl_check_v1 <?=$arSubSection['CLASS']?>"><?=LANGUAGE_ID=='en'?$arSubSection['UF_EN_NAME']:$arSubSection['NAME']?></a>
                                                                        </div>
                                                                    </label>
                                                                </li>
                                                            <? } ?>
                                        ...
                                        <div class="accordion">
                                            <div class="accordion__item js-accordion__item">
                                                ...
                                                <div class="accordion__content accordion__content--visible-md js-accordion__content"
                                                     ...
                                                     data-prop="SIZES_CLOTHING">
                                                    <div class="catalog-filter__size mod_1">
                                                        <?foreach ($arResult['PROPERTY_VALUES']['SIZES_CLOTHING'] as $val_id => $val) {
                                                            if (trim($val_id)) {?>
                                                                <div class="catalog-filter__size-item">
                                                                    <label for="check_<?= str_replace(' ', '-', 'SIZES_CLOTHING' . $val_id) ?>"
                                                                           class="checkbox">
                                                                        <input type="checkbox"
                                                                               data-val-id="<?= $val_id; ?>"
                                                                               name="FILTER[PROP]['SIZES_CLOTHING'][]"
                                                                               value="<?= $val_id ?>"
                                                                               id="check_<?= str_replace(' ', '-', 'SIZES_CLOTHING' . $val_id) ?>"
                                                                               class="checkbox__input"
                                                                            <?if (in_array($val_id, $arResult['FILTRATED_VALUES']['PROP']['SIZES_CLOTHING'])) {
                                                                                echo 'checked="checked" ';
                                                                            }?>
                                                                        >
                                                                        <span class="checkbox__icon"></span>
                                                                        <span class="checkbox__label">
                                                                            <?= $val_id == "ONE_SIZE" ? "OS" : $val_id ?>
                                                                        </span>
                                                                    </label>
                                                                </div>
                                                            <?}
                                                            ...
                                                            if (trim($val)){?>
                                                                <div class="catalog-filter__size-item">
                                                                    <label for="check_<?= str_replace(' ', '-', 'SIZES_TRAINERS' . $val) ?>"
                                                                        ...
                                                                        >
                                                                        <span class="checkbox__icon"></span>
                                                                        <span class="checkbox__label"> <!--style="line-height: unset !important; display: flex; align-items: center;">-->
																			<?
																			// Checking if sizes have a dash in them, adding new line after dash if it exists																				
																			$val_with_br = (strpos($val, '-') !== false) ? str_replace('-', '-<br>', $val) : $val;
                                                                            $val_with_br = (strpos($val_with_br, 'Woman') !== false) ? str_replace('Woman', '', $val_with_br) . "<i>woman</i>" : $val_with_br;
																			?>
                                                                            <?= $val == "ONE_SIZE" ? "OS" : $val_with_br ?>
                                                                        </span>
                                                                    </label>
                                                                </div>
                                                            <?}
                                                                    ...
                                                                    <div class="catalog-filter__size-item">
                                                                        <label for="check_<?= str_replace(' ', '-', 'SIZES_TRAINERS_EU' . $val) ?>"
                                                                            ...
                                                                            <span class="checkbox__label" style="line-height: unset !important; display: flex; align-items: center;">
																				<?
																				// Checking if sizes have a dash in them, adding new line after dash if it exists																				
																				$val_with_br = (strpos($val, '-') !== false) ? str_replace('-', '-<span style="line-height: 1 !important;">', $val).'</span>' : $val;
																				?>
                                                                                <?= $val == "ONE_SIZE" ? "OS" : $val_with_br ?>
                                                                            </span>
                                                                        </label>
                        ...
                        <div class="grid-row">
                            ...
                            <? foreach ($arResult['PROPERTIES'] as $prop) {
                                if ($prop['CODE'] == 'SELECTIONS' || $prop['CODE'] == 'CML2_MANUFACTURER') continue;
                                ...
                                if (count($arResult['PROPERTY_VALUES'][$prop['CODE']]) > 1) {
                                    ...
                                    <?} else {?>
                                        <?if ($prop['CODE'] == 'SIZES_TRAINERS_EU')
                                            continue;
                                        ?>
                                        <?if ($prop['CODE'] == 'SIZES_TRAINERS'){?>
                                            <div class="col-xl-3 col-lg-4">
                                                <div class="catalog-filter__size-wrapper">
                                                    <div class="grid-row">
                                                        <div class="col-md-6 col-lg-12">
                                                            <div class="accordion">
                                                                <div class="accordion__item js-accordion__item">
                                                                    ...
                                                                    <div class="accordion__content accordion__content--visible-md js-accordion__content" <?if ($needShow){ ?>style="display: block"<?}?> data-prop="<?= $prop['CODE']; ?>">
                                                                        <div class="catalog-filter__size <?=$curSize !== 'US' ? '_hide' : ''?> js-filter-wrap <?if (strpos($prop['CODE'], 'SIZES') !== false) { ?>mod_1<?}?>" id="filterShoesUS">
                                                                            <?foreach ($arResult['SIZES_US_TRAINERS'] as $val){
                                                                                if (trim($val)){?>
                                                                                    <div class="catalog-filter__size-item">
                                                                                        <label for="check_<?= str_replace(' ', '-', $prop['CODE'] . $val) ?>"
                                                                                               class="checkbox">
                                                                                            <input type="checkbox"
                                                                                                   data-val-id="<?= $val; ?>"
                                                                                                   name="FILTER[PROP][SIZES_TRAINERS][]"
                                                                        ...
                                                                        <?if (!empty($arResult['SIZES_EU_TRAINERS'])){?>
                                                                            <div class="catalog-filter__size <?=$curSize !== 'EU' ? '_hide' : ''?> js-filter-wrap <?if (strpos($prop['CODE'], 'SIZES') !== false) { ?>mod_1<?}?>" id="filterShoesEU">
                                                                                <?foreach ($arResult['SIZES_EU_TRAINERS'] as $val) {
                                                                                    if (trim($val)) {
                                                                                        ?>
                                                                                        <div class="catalog-filter__size-item">
                                                                    ...
                                                                    switch ($prop['PROPERTY_TYPE']) {
                                                                        ...
                                                                        case 'S': ?>
                                                                            ...
                                                                            <div class="accordion__content accordion__content--visible-md js-accordion__content"
                                                                                ...
                                                                                if (strpos($prop['CODE'], 'SIZES') !== false) { ?>mod_1<?
                                                                                } ?>">
                            ...
                            <div class="col-xl-3">
                                ...
                                <div class="catalog-filter__link">
                                    <a class="btn btn--secondary js_catalog-filter__clear kdx_clear_filter"><?= GetMessage('FILTER_RESET') ?></a>
                                </div>
                            </div>
