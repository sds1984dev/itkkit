                                                                ...
                                                                <div class="catalog-filter__size-item">
                                                                    <label for="check_<?= str_replace(' ', '-', 'SIZES_TRAINERS' . $val) ?>"
                                                                        ...
                                                                        <span class="checkbox__label" style="line-height: unset !important; display: flex; align-items: center;">
																			...
																			$val_with_br = (strpos($val, '-') !== false) ? $val_with_br = str_replace('-', '-<br>', $val) : $val_with_br = $val;
																			?>																		
                                                                    ...
                                                                    <div class="catalog-filter__size-item">
                                                                        <label for="check_<?= str_replace(' ', '-', 'SIZES_TRAINERS_EU' . $val) ?>"
                                                                            ...
                                                                            <span class="checkbox__label" style="line-height: unset !important; display: flex; align-items: center;">
																				<?
																				// Checking if sizes have a dash in them, adding new line after dash if it exists																				
																				$val_with_br = (strpos($val, '-') !== false) ? $val_with_br = str_replace('-', '-<span style="line-height: 1 !important;">', $val).'</span>' : $val_with_br = $val;
																				?>
                                                                                <?= $val == "ONE_SIZE" ? "OS" : $val_with_br ?>
                                                                            </span>
                                                                        </label>
