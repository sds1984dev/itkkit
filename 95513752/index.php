...
if (($time <= $start ) && ($time >= $end)) {?>
    <noscript><meta http-equiv="refresh" content="0; https://www.itkkit.com/noscript.txt" /></noscript>
    <script>
    document.cookie = "nobot=true";
    </script>
    <?
   
    
    if (isset($_COOKIE['nobot'])==false){
        sleep(1);?>
        <script>
            document.cookie = "nobot=true";
        ...
        <?die();?>
    <?};
    if (isset($_COOKIE['nobot'])==false){die();};?>
<?}?>
<?//--отключение ботов?>
<?
